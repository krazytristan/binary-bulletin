    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
      ...
      {fetching ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {videos.map((v) => (
            <div key={v.id} className="bg-white rounded-none  border border-gray-100 overflow-hidden group hover: transition">
              <div className="aspect-video bg-gray-900 relative">
                ...
                <button 
                  ...
                  className="absolute top-2 right-2 bg-white/90 p-2 rounded-none text-red-500 opacity-0 group-hover:opacity-100 transition "
                >
                  <Trash2 size={16} />
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full border-gray-100 bg-gray-50 p-3 rounded-none focus:ring-2 focus:ring-black outline-none border transition"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full border-gray-100 bg-gray-50 p-3 rounded-none focus:ring-2 focus:ring-black outline-none border h-20 transition"
                />
              </div>
              ...
              <div className="relative border-2 border-dashed border-gray-100 rounded-none p-4 bg-gray-50 text-center">
